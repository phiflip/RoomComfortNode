...
/* OTAA para*/
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x00, 0x00, 0x00}; // change here
uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // change here
uint8_t appKey[] = { 0xF2, 0x2D, 0xF6, 0x49, 0x6E, 0x88, 0xA0, 0x94, 0x60, 0xAD, 0x0F, 0x4E, 0x00, 0x00, 0x00, 0x00 }; // change here


/* ABP para*/
uint8_t nwkSKey[] = { 0xE8, 0x12, 0xC1, 0xC6, 0x7F, 0x59, 0xA6, 0x61, 0xCE, 0xF4, 0x07, 0x43, 0xAA, 0x85, 0xFA, 0x8A };
uint8_t appSKey[] = { 0x7B, 0x88, 0x2E, 0x17, 0x3B, 0x72, 0xDF, 0x87, 0xA3, 0xE7, 0x98, 0x5C, 0x08, 0x5E, 0xAA, 0xAB };
uint32_t devAddr =  ( uint32_t )0x26013E5D;
